...
This explains how to propose a change to cbRt via a pull request using
Git and GitHub. 
...
the [cbRt GitHub repo](https://github.com/emraher/cbRt), and 
...
results for [cbRt on Travis](https://travis-ci.org/emraher/cbRt) (checks on Linux and/or 
