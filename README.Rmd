...
[![Codecov test coverage](https://codecov.io/gh/emraher/cbRt/branch/main/graph/badge.svg)](https://app.codecov.io/gh/emraher/cbRt?branch=main)
<!-- badges: end -->

## Overview

`cbRt` provides an R interface to the Electronic Data Delivery System (EVDS) of the Central Bank of the Republic of Turkey (CBRT). The package enables easy access to a rich collection of economic data including exchange rates, interest rates, inflation indicators, and more.
...
The package now fully supports EVDS API v3 with automatic handling of the 150 observation limit:
...
- **Supports**: Daily, business days, weekly, bi-monthly, monthly, quarterly, semi-annual, yearly
...
- **Getting Started Guide**: See `vignette("getting-started")` for comprehensive examples
